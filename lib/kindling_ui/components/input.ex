defmodule KindlingUI.Components.Input do
  @moduledoc false
  ...
  attr :type, :string,
    ...
    values: ~w(checkbox color date datetime-local email file month number password
               range search select tel text textarea time toggle url week)
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BrazierWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BrazierWeb.Gettext, "errors", msg, opts)
    end
  end
